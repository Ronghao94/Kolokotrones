...
data <- read_excel("/Users/raelinecv/RStudio/Kolokotrones/data/41586_2010_BFnature08920_MOESM90_ESM.xls", skip = 6)

head(data)
```

```{r parse-data, fig.cap="A plot of random numbers"}
